...
@set WGET=%WGET% https://sourceforge.net/projects/gnuwin32/files/libiconv/1.9.2-1/libiconv-1.9.2-1-bin.zip
@set WGET=%WGET% https://downloads.sourceforge.net/project/gnuwin32/sed/4.2.1/sed-4.2.1-bin.zip
...
@set WGET=%WGET% https://www.irontcl.com/downloads/irontcl-amd64-8.6.7.zip
